...
* Extend code to allow update an item in the todolist app.
...
ionic serve
```
You should able to update an item by connecting to mock server. Verify by watching the network tab in  chrome dev tools
